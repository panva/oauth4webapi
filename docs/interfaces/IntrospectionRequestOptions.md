...
[`as.introspection\_endpoint`](AuthorizationServer.md#introspection_endpoint). Default is

- True when
  [`client.introspection\_signed\_response\_alg`](Client.md#introspection_signed_response_alg) is
  set
- False otherwise
